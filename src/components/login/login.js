    ...
    render() {
      return <div className="component-login">
        ...
        <div className='welcome'>
            <h1 id="a6">Customer Login</h1>
       </div>
        
        <br></br><br></br><br></br>
          {/* <table className='t2' border="3" align='center' bgcolor='#468375'>
            <tr>
              <th colSpan="2">
                Login Page
              </th>
          ...
          <h1>Login</h1>
              ...
              <input type="text" id="userName" value={this.state.userName} onChange={this.changeUserName.bind(this)} name="u" placeholder="Username" required="required" />
                <input type="password" id="passWord" value={this.state.passWord} onChange={this.changePassword.bind(this)} name="p" placeholder="Password" required="required" />
                  <input type="button" class="btn btn-primary btn-block btn-large" value="Login" onClick={this.login}/>
                  </form>
                </div>
            </table>
