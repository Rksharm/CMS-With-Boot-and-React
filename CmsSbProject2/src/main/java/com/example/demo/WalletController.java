...
public class WalletController {
	...
	@CrossOrigin(origins = "http://localhost:3000")
	@RequestMapping("/addToWallet/{id}/{walSource}/{walAmount}")
	public String addToWallet(@PathVariable int id,@PathVariable String walSource,@PathVariable double walAmount) {
		return dao.addToWallet(id,walSource,walAmount);
	}
